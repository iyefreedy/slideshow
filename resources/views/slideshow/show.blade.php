...
<body>
    <div class="relative w-screen h-screen bg-wisuda-27 bg-cover bg-no-repeat flex justify-center items-center ">
        ...
        <div class="absolute py-4 px-6 transition-opacity duration-700 flex flex-col {{ $loop->index == $index ? 'current' : '' }} slide">
            <div class="flex flex-row mb-4">
                <div class="h-80 w-64 border-4 border-yellow-400 rounded-md mr-8">
                    <img src="{{ asset('storage/images/' . $graduate->nim . '.jpg') }}" alt="Graduate Image" class="h-full w-full">
                </div>
                <div class="flex min-w-[32rem] max-w-lg flex-col justify-center py-2 px-4 bg-white border-4 border-yellow-400 rounded-md ">
