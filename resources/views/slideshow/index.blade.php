...
<body>
    <div class="relative w-screen h-screen bg-hero bg-cover bg-no-repeat flex justify-center items-center ">
            ...
            <div
                ...
                <div class="flex flex-row mb-4">
                    <div class="h-80 w-64 border-4 border-yellow-400 rounded-md mr-8">
                        <img src="{{ asset('storage/images/' . $graduate->nim . '.jpg') }}" alt="Graduate Image"
                            class="h-full w-full">
                    </div>
                    <div
