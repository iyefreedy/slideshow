...
<body>
    <div class="relative w-screen h-screen bg-wisuda-28 bg-cover bg-no-repeat flex justify-center items-center ">
        @foreach ($graduates as $graduate)
            <div
                class="absolute py-4 px-6 transition-opacity duration-700 flex flex-col {{ $loop->index == 0 ? 'current' : '' }} slide">
                <div class="flex flex-row mb-4">
                    ...
                    <div
                        class="flex min-w-[42rem] max-w-lg flex-col justify-center py-2 px-4 bg-white border-4 border-yellow-400 rounded-md ">
